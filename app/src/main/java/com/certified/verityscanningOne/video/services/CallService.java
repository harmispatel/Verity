package com.certified.verityscanningOne.video.services;
...
import com.certified.verityscanningOne.video.util.ChatPingAlarmManager;
...
import static com.quickblox.messages.a.c;
...
public class CallService extends Service {
    ...
    private void startSuitableActions() {
        if (currentCommand == Consts.COMMAND_LOGIN) {
            ...
            Log.e("Call Service : ","command login");

        } else if (currentCommand == Consts.COMMAND_LOGOUT) {
            logout();
            Log.e("Call Service : ","command logout");
        }
    }
