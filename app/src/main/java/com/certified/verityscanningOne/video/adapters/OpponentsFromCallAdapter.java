package com.certified.verityscanningOne.video.adapters;
...
import com.certified.verityscanningOne.video.utils.QBRTCSessionUtils;
...
public class OpponentsFromCallAdapter extends RecyclerView.Adapter<OpponentsFromCallAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.video_list_item_opponent_from_call, null);
