...
public class ScreenShareFragment extends BaseToolBarFragment {
    ...
    int getFragmentLayout() {
        return R.layout.video_fragment_pager;
    }
    ...
    public static class MyAdapter extends FragmentPagerAdapter {
        ...
        private int[] images = {R.drawable.verity_login_screen_logo, R.drawable.verity_login_screen_logo, R.drawable.group_call, R.drawable.verity_login_screen_logo};
