...
public class TermsAndConditionActivity extends BaseActivity {
    ...
    private void setUI() {
        ...
        try {
          ...
          //  webview.loadUrl("http://certified.bz/index.php/faq3/terms-and-conditions");
            webview.loadUrl("https://s3-us-west-1.amazonaws.com/verity.app/TermsAndConditions.html");
            ...
            webview.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    TermsAndConditionActivity.this
